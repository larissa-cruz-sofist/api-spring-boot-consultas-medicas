...
class MedicoControllerTest {
	...
	void deveriaRetornarStatus200QuandoCadastrarMedicoInformacoesValidas() throws Exception {
		...
		DadosCadastroMedico dadosCadastroMedico = new DadosCadastroMedico("Marcos", "marcoslinhares@vold.med",
				"892083001", "801208", especialidade,
				new DadosEndereco("rua alegre", "santa paula", "12345412", "Sao Paulo", "SP", "bloco A", "200"));
	...
	void deveriaRetornarStatus204QuandoExcluirMedicoExistente(boolean ativo) throws Exception {
		...
		Medico medico = new Medico(Long.valueOf(123), "Carlos", "carlos@voll.med", "965412298", "801118", especialidade,
				endereco, ativo);
	...
	void deveriaRetornarStatus200QuandoAlterarMedicoExistente() throws Exception {
		...
		DadosAtualizacaoMedico dadosAtualizacaoMedico = new DadosAtualizacaoMedico(medicoSimulado.getId(),
				"Fernando Silva", "892083001",
				new DadosEndereco("rua silvia", "santa paula", "12388412", "Sao Paulo", "SP", "bloco B", "201"));
