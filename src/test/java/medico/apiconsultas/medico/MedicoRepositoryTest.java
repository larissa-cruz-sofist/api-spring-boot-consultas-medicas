...
class MedicoRepositoryTest {
	...
	void escolherMedicoAleatorioLivreNaDataCenarioSemMedicoDisponivel() {
		// given
	...
	void escolherMedicoAleatorioLivreNaDataCenarioComMedicoDisponivel() {
		var proximaSegundaAs10 = LocalDate.now().with(TemporalAdjusters.next(DayOfWeek.MONDAY)).atTime(10, 0);
	...
	void testFindAllByAtivoTrueMedico() {
		...
		Medico medico1 = new Medico(null, "Carlos", "carlos@voll.med", "965412298", "801118", especialidade1, endereco1,
				true);
		Medico medico2 = new Medico(null, "Georgia", "georgia@voll.med", "95211144", "800008", especialidade2,
				endereco2, true);

		medicoRepository.save(medico1);
		medicoRepository.save(medico2);

		Medico medicoInativo = new Medico(null, "Elisa", "elisa@voll.med", "00004844", "521045", especialidade3,
				endereco3, false);
